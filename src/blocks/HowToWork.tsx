            ...
            <div className="main__how-to-work__cards">
                <div className="main__how-to-work__card">
                    ...
                    <div className="main__how-to-work__card-title">
                        <span>Прочитай задание внимательно</span>
                    </div>
                    <div className="main__how-to-work__card-txt">
                        <span>Думаю у тебя не займет это больше двух-трех минут</span>
                    </div>
                </div>
                <div className="main__how-to-work__card">
                    <div className="main__how-to-work__card-logo">
                    ...
                    <div className="main__how-to-work__card-title">
                        <span>Изучи весь макет заранее</span>
                    </div>
                    <div className="main__how-to-work__card-txt">
                        <span>
